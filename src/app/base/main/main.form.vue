<template>
    ...
    <div class="mb-2"></div>
    <awInputText :fieldElement="TextElement" @update:field="updateCallBackFieldElementInputText" />
    <div class="mb-2"></div>
    ...
    <div class="mb-2"></div>
    <awCheckbox :fieldElement="CheckboxElement" @update:field="updateCallBackFieldElementCheckbox" />
    <div class="mb-2"></div>
    <div>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const callBackFieldElementInputText = ref<FieldElementItem>();
            ...
            const CheckboxElement = ref<FieldElementItem>(new FieldElementItem({
                Name: 'CheckboxElement',
                ShowLabel: false,
                Label: 'Checkbox',
                Required: true,
                Disabled: false,
                PlaceHolder: 'CheckboxElement'
            }));
            ...
            const load = () => {
                ...
                CheckboxElement.value.Loading = loading.value;
                setTimeout(() => {
                    loading.value = false;
                    dateElement.value.Loading = loading.value;
                    numberElement.value.Loading = loading.value;
            ...
            const updateCallBackFieldElementInputText = (value: any) => {
                console.log('updateCallBackFieldElementInputText', value)
            }

            const updateCallBackFieldElementCheckbox = (value: any) => {
                console.log('updateCallBackFieldElementCheckbox', value)
            }

            return { loading, load, dateElement, numberElement, TextElement, MultiSelectElement, PasswordElement, SingleSelectElement, TextAreaElement, CheckboxElement, ButtonElement, DataTableElement, pageFilter, updatePageFilter, updateCallBackFieldElementDatePicker, updateCallBackFieldElementInputNumber, updateCallBackFieldElementInputText, updateCallBackFieldElementCheckbox }
        },
    });
</script>
